                ...
                <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center pointer-events-none">
                    ...
                    >
                        ...
                        <div className="p-8 pb-0 shrink-0">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight">
                                            {editTransactionId ? 'Edit Entry' : 'Manual Entry'}
                                        </h2>
                                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Finance Manager</p>
                                    </div>
                                </div>
                                <button onClick={onClose} className="p-2.5 bg-slate-100 dark:bg-slate-800 rounded-full text-slate-500 hover:rotate-90 transition-transform">
                                    <X className="w-5 h-5" />
                                </button>
                            </div>
                            ...
                            {/* Amount Input Section - Central Focus */}
                            <div className="text-center mb-10">
                                ...
                                <div className="h-1 w-20 bg-indigo-500 mx-auto mt-2 rounded-full opacity-20"></div>
                            </div>
                        </div>
