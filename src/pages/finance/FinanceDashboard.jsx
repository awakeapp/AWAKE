...
const FinanceDashboard = () => {
 ...
 className="min-w-[140px] bg-indigo-500 p-4 rounded-2xl shadow-lg shadow-indigo-500/20 cursor-pointer transition-opacity flex flex-col justify-between text-white"
 >
 ...
 className="min-w-[140px] bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-lg shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 cursor-pointer transition-opacity"
 >
 ...
 className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl font-bold transition-transform shadow-lg shadow-indigo-500/20"
 >
