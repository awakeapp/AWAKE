...
const FinanceEMI = () => {
    ...
    const summary = useMemo(() => {
        ...
        for (const loan of loans) {
            totalEMI += parseFloatSafe(loan.emiAmount);
            totalOutstanding += parseFloatSafe(loan.remainingPrincipal);
    ...
    const getLoanStatus = (loan) => {
        if (parseFloatSafe(loan.remainingPrincipal) <= 0) return { label: 'Cleared', color: 'text-emerald-500', bg: 'bg-emerald-50 dark:bg-emerald-900/20' };
