...
const RamadanDashboard = () => {
    ...
    const locationNode = displayName ? (
        <ActionButton 
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 dark:bg-slate-800/50 hover:bg-slate-200 dark:hover:bg-slate-800 rounded-full border border-slate-200 dark:border-slate-800"
        >
            <Compass className="w-3.5 h-3.5 text-emerald-500" />
            <span className="text-xxs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-widest truncate max-w-[100px]">
                {displayName.split(',')[0]}
            </span>
        </ActionButton>
    ) : null;
            ...
            >
                <div className="flex-1 flex flex-col items-center justify-center py-32 space-y-6">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-xxs font-bold text-slate-400 dark:text-[#8E8E93] uppercase tracking-[0.2em] mt-1">Syncing Celestial Data</p>
                    </div>
                </div>
            </PageLayout>
        );
        ...
        >
            ...
            {error && !dailyTimings && (
                ...
                >
                    ...
                    <ActionButton variant="primary" onClick={() => window.location.reload()} className="px-4 py-2 bg-rose-600 text-white rounded-xl text-xxs uppercase tracking-widest" label="Retry" />
                </motion.div>
            )}
                 ...
                 <div className="relative z-20 p-5 sm:p-6 flex flex-col gap-4">
                     <div className="flex justify-between items-center">
                        ...
                        >
                             ...
                             <p className="text-white/60 text-xxs font-bold uppercase tracking-widest mt-1 drop-shadow-md">
                        ...
                        <motion.div 
                            ...
                            animate={{ opacity: 1, x: 0 }}
                        >
                            <span className="bg-white/10 backdrop-blur-xl text-white px-3 py-1.5 rounded-xl text-micro font-black tracking-[0.2em] uppercase border border-white/10 shadow-sm">
                     ...
                     <div className="mt-2 flex flex-col">
                         <motion.p 
                            ...
                            initial={{ opacity: 0, y: 10 }}
                            animate={{ opacity: 1, y: 0 }}
                            className="text-white/60 uppercase tracking-[0.2em] text-xxs font-black mb-1 drop-shadow-md"
                         >
                             {nextEvent}
                         </motion.p>
                         <motion.div 
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <span className={clsx("text-micro font-black uppercase tracking-widest mb-0.5", 
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center text-white">
                        ...
                        <span className="text-micro font-black uppercase tracking-widest mb-0.5 opacity-80">Iftar Time</span>
            ...
            {isRamadanActive ? (
                ...
                >
                    ...
                    <p className="text-sm-minus font-bold text-slate-500 dark:text-[#48484A] mt-2">
