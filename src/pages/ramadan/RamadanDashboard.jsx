        ...
        >
            ...
            {error && !dailyTimings && (
                ...
                >
                    ...
                    <ActionButton variant="primary" onClick={() => window.location.reload()} className="px-4 py-2 bg-rose-600 text-white rounded-xl text-[10px] uppercase tracking-widest" label="Retry" />
                </motion.div>
            )}
