...
export function AppHeader({ 
 ...
 <button
 onClick={handleBack}
 className="p-2 bg-transparent hover:bg-slate-100 dark:bg-transparent dark:hover:bg-slate-800 rounded-full transition-colors text-primary-600 dark:text-primary-400 focus:outline-none"
 >
